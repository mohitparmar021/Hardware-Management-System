...
<title>View All Issued Hardware</title>
		...
		<div id="content-wrapper">
			...
			<div class="container-fluid">
				...
				<ol class="breadcrumb">
					...
					<li class="breadcrumb-item active">Issued Record</li>
				</ol>


				<div class="card">
					<div class="container-fluid">
						<h4 class="mt-3">Hardware Issued To All Department</h4>
						<br>
						...
						<table class="table-responsive-lg table-striped mb-3"
							...
							<tbody>
                                ...
                                ResultSet rs=obj.showIssuedRecord();
                                int i=0;
                                while(rs.next())
                        		{
                        	 %>
