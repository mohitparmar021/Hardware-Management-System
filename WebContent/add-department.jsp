	...
	<div id="wrapper">
		...
		<div id="content-wrapper" class="bg-white">
			...
			<div class="container-fluid">
                ...
                <div class="card">
                       <div class="container-fluid">  
                           <form action="AddDepartment" method="post" onsubmit="return validation()">
                                 <div class="form-group">
                                       <label for="department" class="mt-3">Department Name</label>
                                       <input type="text" name="department"  autocomplete="off" id="department" class="form-control component-field">
                                 </div>
                   ...
                   <div class="card mb-3 mt-4">
                       <div class="card-body">     
                           ...
                           <%
                                ...
                                ResultSet rs=obj.showDepartment();
                                int i=0;
                                while(rs.next())
                        		{
                        	 %>
                                    	 ...
                                    	 <tr>
                                              ...
                                              <td><a href="delete-department.jsp?id=<%=rs.getInt(1) %>">Delete</a></td>
                                          </tr>
                                 <%
                        		}
                                 %>
